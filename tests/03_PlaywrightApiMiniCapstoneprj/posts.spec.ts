...
test.describe('Path and Query Parameter API Testing using Posts URL', () => {
    ...
    test(`TC03 - Get post by ID using Query Parameter and validate the response`, async ({ request }) => {

        const id = 5;   

        // Fetching the get request using Query Parameter
    ...
    test(`TC04 - Get post using Query Parameter for more than 1 id and validate the response`, async ({ request }) => {

        const id_1 = 5;
        const id_2 = 6;  

        // Fetching the request for 2 users
        ...
        expect(jsonData[1].id).toBe(id_2);
    });

    test(`TC05 - Update post by ID and validate the response using Query Parameter`, async ({ request }) => {
        ...
        // Updating the request using Patch
